...
iverilog -g2012 -P tb_mc.RAM_ADDR_W=16 -P tb_mc.PAD_COUNT=4 -P tb_mc.SLOT_WORDS=9344 -P tb_mc.TRACE=1 -o sim/tb_mc_gb64t.vvp sim/tb_mc.sv $SRC
vvp -n sim/tb_mc_gb64t.vvp | tail -3
